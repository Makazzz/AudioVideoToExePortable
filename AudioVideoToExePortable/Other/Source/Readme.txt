...
user in an INI file next to AudioVideoToExePortable.exe called AudioVideoToExePortable.ini.
...
copy AppNamePortable.ini from this directory to AudioVideoToExePortable.ini next to
AudioVideoToExePortable.exe. The options in the INI file are as follows:
